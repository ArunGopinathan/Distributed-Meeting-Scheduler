...
public class SignUpActivity extends ActionBarActivity {
    ...
    TextView mFirstNameView, mLastNameView, mEmailView, mPasswordView, mConfirmPasswordView;
    Button btnSignUp;
    private String URLFORMAT = "http://%s/DistributedMeetingSchedulerWebService/DMSWebService/Register/";
    private String URL = "http://dms.ngrok.io/DistributedMeetingSchedulerWebService/DMSWebService/Register/";
    String response = "";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mFirstNameView = (TextView) findViewById(R.id.txtFirstName);
